        ...
        <AnimatePresence>
          {open && (
            <>
              ...
              >
                <div className="custom_modal_inner h-100 overflow-auto p-4 p-md-5">
                  ...
                  <h3
                    className={`language m-0 fs-4 mb-3`}
                    style={{
                      color: "#939393",
                      fontWeight: "700",
                      lineHeight: 1.4,
                  ...
                  >
                    {t(`projects.${currentProject.name}.subtitle`)}
                  </h3>
                  ...
                  <div className="col-12 row">
                    {t(`projects.${currentProject.name}.challenges`, {
                      returnObjects: true,
                    }).map((item, index) => (
                      <div
